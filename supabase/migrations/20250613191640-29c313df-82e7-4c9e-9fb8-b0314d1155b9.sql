...
-- Corrigir a função join_matchmaking_queue para resolver ambiguidade de user_id
...
-- Também corrigir a função create_game_when_ready para resolver qualquer ambiguidade
